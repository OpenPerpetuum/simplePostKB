# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-07-30 20:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=64, unique=True)),
                ('corp', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='kbsite.Corp')),
            ],
        ),
        migrations.CreateModel(
            name='Robot',
        ...
        migrations.AddField(
            model_name='kill',
            name='victim',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='kbsite.Player'),
        ),
        migrations.AddField(
            model_name='kill',
            name='zone',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='kbsite.Zone'),
        ),
        migrations.AddField(
